...
```text
/Users/guanxuzeng/LocalDocuments/GitLocalStore/MacAI/.build/models/ggml-base.bin
```
...
```bash
cd /Users/guanxuzeng/LocalDocuments/GitLocalStore/MacAI
./target/debug/aiworkd
```
...
MODEL_PATH="/Users/guanxuzeng/LocalDocuments/GitLocalStore/MacAI/.build/models/SmolLM2-135M-Instruct-Q4_K_M.gguf"
...
```bash
./target/debug/ai run \
  /Users/guanxuzeng/LocalDocuments/GitLocalStore/MacAI/.build/models/SmolLM2-135M-Instruct-Q4_K_M.gguf
```
